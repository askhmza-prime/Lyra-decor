'use client'
import Link from 'next/link' import { useCartStore } from '@/store/cartStore'
export default function ProductPage({ params, }: { params: { id: string } }) {
const addToCart = useCartStore( (state) => state.addToCart )
const { id } = params
const products = [ { id: 'brass-vase', name: 'Brass Vase', price: '₹4,999', image: '/products/brass-vase.jpg', description: 'Luxury handcrafted brass vase designed for premium interiors.', },
{
  id: 'wall-art',
  name: 'Metal Wall Art',
  price: '₹7,499',
